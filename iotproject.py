...
while True:
	...
	req = requests.get("http://data.sparkfun.com/input/aGOE6rY5mxcxX1GNnOKq?" +
        ...
        if now.hour == 21 and now.minute > 00 and now.minute < 25:
           twil.mes(x[0])
        if now.hour == 12 and now.minute > 00 and now.minute < 25:
           twil.mes(x[0])                      
        if now.hour == 04 and now.minute > 00 and now.minute < 25:
           twil.mes(x[0])                      
